...
export default function FinalCTA() {
  ...
  return (
    <section className="bg-palm-blue">
      {/* Gold accent line */}
      <div className="h-px bg-gradient-to-r from-transparent via-palm-gold/50 to-transparent" />

      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-20 md:py-28 flex flex-col items-center text-center gap-6">
